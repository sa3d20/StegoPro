...
################################################################################
## Form generated from reading UI file 'Mp3HidefpMluu.ui'
##
...
class Ui_AudioGUI_form(object):
    def setupUi(self, AudioGUI_form):
        if not AudioGUI_form.objectName():
            AudioGUI_form.setObjectName(u"AudioGUI_form")
        AudioGUI_form.resize(500, 200)
        AudioGUI_form.setMinimumSize(QSize(0, 0))
        AudioGUI_form.setMaximumSize(QSize(500, 200))
        icon = QIcon()
        icon.addFile(u":/img/audio.png", QSize(), QIcon.Normal, QIcon.Off)
        AudioGUI_form.setWindowIcon(icon)
        AudioGUI_form.setStyleSheet(u"QProgressBar:horizontal {\n"
...
"}")
        self.centralwidget = QWidget(AudioGUI_form)
        ...
        self.SelectCarrier = QLineEdit(self.frame_3)
        self.SelectCarrier.setObjectName(u"SelectCarrier")

        self.horizontalLayout_3.addWidget(self.SelectCarrier)

        self.CBrowse_BTN = QPushButton(self.frame_3)
        self.CBrowse_BTN.setObjectName(u"CBrowse_BTN")

        self.horizontalLayout_3.addWidget(self.CBrowse_BTN)
        ...
        self.StighideEncode = QPushButton(self.frame)
        self.StighideEncode.setObjectName(u"StighideEncode")
        self.StighideEncode.setGeometry(QRect(189, 12, 150, 26))
        self.StighideEncode.setMaximumSize(QSize(200, 16777215))
        font = QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.StighideEncode.setFont(font)
        self.Mp3Encode = QPushButton(self.frame)
        self.Mp3Encode.setObjectName(u"Mp3Encode")
        self.Mp3Encode.setGeometry(QRect(189, 12, 150, 26))
        self.Mp3Encode.setMaximumSize(QSize(200, 16777215))
        self.Mp3Encode.setFont(font)

        self.verticalLayout.addWidget(self.frame)

        self.Stutus = QLabel(self.centralwidget)
        self.Stutus.setObjectName(u"Stutus")
        font1 = QFont()
        font1.setPointSize(12)
        self.Stutus.setFont(font1)
        self.Stutus.setStyleSheet(u"color: rgb(85, 255, 0);")
        self.Stutus.setAlignment(Qt.AlignCenter)

        self.verticalLayout.addWidget(self.Stutus)

        AudioGUI_form.setCentralWidget(self.centralwidget)

        self.retranslateUi(AudioGUI_form)

        QMetaObject.connectSlotsByName(AudioGUI_form)
    # setupUi

    def retranslateUi(self, AudioGUI_form):
        AudioGUI_form.setWindowTitle(QCoreApplication.translate("AudioGUI_form", u"Stego", None))
        self.SelectCarrier.setPlaceholderText(QCoreApplication.translate("AudioGUI_form", u"Select Sound.wav", None))
        self.CBrowse_BTN.setText(QCoreApplication.translate("AudioGUI_form", u"browse", None))
        self.Path_txt.setPlaceholderText(QCoreApplication.translate("AudioGUI_form", u"Select Secret data.txt", None))
        self.Browse_Btn.setText(QCoreApplication.translate("AudioGUI_form", u"browse", None))
        self.StighideEncode.setText(QCoreApplication.translate("AudioGUI_form", u"StegHideEncode", None))
        self.Mp3Encode.setText(QCoreApplication.translate("AudioGUI_form", u"Mp3Encode", None))
        self.Stutus.setText("")
    # retranslateUi
